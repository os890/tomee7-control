...
/**
 * OpenEJB specific implementation of {@link CdiContainer}.
 */
@SuppressWarnings("UnusedDeclaration")
public class TomeeContainerControl implements CdiContainer
{
    private static final Logger LOG = Logger.getLogger(TomeeContainerControl.class.getName());
    ...
    static
    {
        ...
        try
        {
            TomeeContainerControl.class.getClassLoader().loadClass("org.apache.openejb.server.ServiceManager");
