...
public class OpenWebBeansContextControl implements ContextControl
{
    ...
    */
    ...
    private void startSessionScope()
    {
        ...
        Object mockSession = getMockSession();
        contextsService.startContext(SessionScoped.class, mockSession);
    }

    private Object getMockSession()
    {
    ...
    private void startRequestScope()
    {
        ...
        ServletContext servletContext = MockServletContext.getInstance();
        ServletRequestEvent servletRequestEvent =
            new ServletRequestEvent(servletContext, new MockServletRequest(getMockSession()));
        contextsService.startContext(RequestScoped.class, servletRequestEvent);
    }
